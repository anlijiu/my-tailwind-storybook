...
export const Textarea = React.forwardRef<HTMLDivElement, TextareaProps>(
  (
    { variant, color, displaySize, label, error, success, resize, labelProps, shrink, className, ...rest },
    ref,
  ) => {
    // 1. init
    ...
    displaySize = displaySize ?? defaultProps.displaySize;
    ...
    const textareaClasses = classnames(
      ...
      objectsToString(textareaVariant.sizes[findMatch(valid.sizes, displaySize, "md")].textarea),
    ...
    const labelClasses = classnames(
      ...
      objectsToString(textareaVariant.sizes[findMatch(valid.sizes, displaySize, "md")].label),
...
Textarea.propTypes = {
  ...
  displaySize: PropTypes.oneOf(propTypesSize),
