...
import { InputStylesType } from "../theme";
...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const { defaultProps, valid, styles } = input as Required<InputStylesType>;
    ...
    const inputSize = inputVariant.sizes[findMatch(valid.sizes, displaySize, "md")];
    ...
    // 4. return
    return (
      <div {...containerProps} ref={containerRef} className={containerClasses}>
