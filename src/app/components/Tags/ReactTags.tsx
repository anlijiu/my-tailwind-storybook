...
import { ReactTagsProps, ReactTagsState } from './types';
...
class ReactTags extends Component<ReactTagsProps, ReactTagsState> {
  ...
  reactTagsRef: React.RefObject<HTMLDivElement>;
  ...
  handleTagClick(i, tag, e: TagInterface) {
  ...
  handleChange(e) {
    console.log("ReactTags.tsx  handleChange   value: ", e.target.value.trim())
