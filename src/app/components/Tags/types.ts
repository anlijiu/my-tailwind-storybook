...
export interface ReactTagsProps {
    ...
    handleDelete: ((i: number, e: Event) => void);
    ...
    handleTagClick?: ((i: number, tag: Tag) => void) | undefined;
    ...
    onTagUpdate?: ((id: number|string, tag?: Tag) => void) | undefined;
...
export interface ReactTagsState {
    ...
    currentEditIndex: number|string;
}
